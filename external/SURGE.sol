...
contract SURGE is IERC20, Context, Ownable, ReentrancyGuard {
    ...
    string constant private  _symbol = "SRG";
    ...
    //Migration Wallet
    address public constant MIGRATION_WALLET = 0xc207cd3f61Da958AA6f4209C5f0a145C056B576f;
    ...
    function _buy(uint256 minTokenOut, uint256 deadline) public nonReentrant payable returns (bool) {
        ...
        require(block.timestamp >= TRADE_OPEN_TIME || msg.sender == MIGRATION_WALLET, "Trading is not Open");
    ...
    address private stablePairAddress = 0x58F876857a02D6762E0101bb5C46A8c1ED44Dc16;
