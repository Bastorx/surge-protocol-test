...
export const tokenABI: AbiItem[] = [
  ...
  {
    inputs: [
      { internalType: "address", name: "newTeamWallet", type: "address" },
      {
        internalType: "address",
  ...
  {
    inputs: [
      { internalType: "uint256", name: "newBuyMul", type: "uint256" },
      {
        internalType: "uint256",
        name: "newSellMul",
        type: "uint256",
  ...
  {
    inputs: [
      { internalType: "address", name: "newStablePair", type: "address" },
      {
        internalType: "address",
        name: "newStableAddress",
        type: "address",
      },
    ],
    name: "changeStablePair",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  {
    inputs: [
      { internalType: "uint256", name: "newteamShare", type: "uint256" },
      {
        internalType: "uint256",
  ...
  {
    inputs: [{ internalType: "uint256", name: "amountBNBIn", type: "uint256" }],
